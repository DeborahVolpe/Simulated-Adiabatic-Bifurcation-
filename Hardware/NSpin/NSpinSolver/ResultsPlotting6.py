...
#obtained output X Y
nome_file_X_Y = "output_file_X_Y6.txt"
...
# obtained output X Y
nome_file_X_Y_Exact = "InputX_Y6.txt"
...
plt.tight_layout()
plt.grid(True)
plt.savefig('6Spin_herdware.png', format='png', bbox_inches='tight')
plt.savefig('X6Spin_herdware.eps', format='eps', bbox_inches='tight')
plt.show()
