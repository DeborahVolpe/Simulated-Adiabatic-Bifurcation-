...
plt.plot(time, X0_l, linewidth=2.0, color='b', label=r'\textit{x0}')
plt.plot(time, Y0_l, linewidth=2.0, color='r', label=r'\textit{y0}')
plt.plot(time, X1_l, linewidth=2.0, color='c', label=r'\textit{x1}')
plt.plot(time, Y1_l, linewidth=2.0, color='m', label=r'\textit{y1}')
plt.plot(time, X0_l_e, linewidth=2.0, color='b',linestyle='dashed', label=r'\textit{x0 software}')
plt.plot(time, Y0_l_e, linewidth=2.0, color='r',linestyle='dashed', label=r'\textit{y0 software}')
plt.plot(time, X1_l_e, linewidth=2.0, color='c',linestyle='dashed', label=r'\textit{x1 software}')
plt.plot(time, Y1_l_e, linewidth=2.0, color='m',linestyle='dashed', label=r'\textit{y1 software}')
...
plt.grid(True)
plt.savefig('Adiabatic2Spin2.png', format='png', bbox_inches='tight')
plt.savefig('Adiabatic2Spin2.eps', format='eps', bbox_inches='tight')
plt.show()
