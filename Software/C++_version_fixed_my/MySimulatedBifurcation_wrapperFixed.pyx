...
def My_SimulatedBifurcationMachineVLSI_fixed(folder, states_numpy, energies, num_runs, h, J, N, K, Delta, delta_t, xi, xi_h, pt_shape, num_iterations, seed, verbose, fractional_bits):
	...
	ret = My_general_simulated_bifurcation_fixed(_folder, _states, _energies, _num_runs, _h, _J, _N, _K, _Delta, _delta_t, _xi, _xi_h, _pt_shape, _num_iterations, _seed, verbose, _fractional_bits)
