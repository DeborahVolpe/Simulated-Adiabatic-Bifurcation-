...
cdef extern from "./SimulatedBifurcationTo.h":
...
def SimulatedBifurcationMachineTo_v1(folder, states_numpy, energies, num_runs, h, J, N, K, Delta, delta_t, xi, xi_h, pt_shape, num_iterations, seed, verbose, M):
	num_vars = len(h)
	...
	ret = To_general_simulated_bifurcation(_folder, _states, _energies, _num_runs, _h, _J, _N, _K, _Delta, _delta_t, _xi, _xi_h, _pt_shape, _num_iterations, _seed, verbose, _M)
